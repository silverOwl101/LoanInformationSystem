...
namespace LoanInformationSystemEmployee
{
    static class Program
    {
        ...
        static void Main()
        {            
            const string mutexName = "LoanInformationSystem_Mutex";
            bool createdNew;
            ...
            {
                MessageBox.Show("The application is already running..", "Loan Information System", MessageBoxButtons.OK, MessageBoxIcon.Information);
